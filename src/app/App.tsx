...
import { IntegrationObjectInterface } from "./IntegrationObjectInterface";
...
export default function App(){
  ...
  if(prototypeMode==="object"){
    return <IntegrationObjectInterface exposure={exposureMap} proof={challengeProof}/>;
  }
